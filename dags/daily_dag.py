...
with DAG(
    ...
    #     op_kwargs={'data_destination_type':DATA_DESTINATION_TYPE.SQL_SERVER,'period_type':PERIOD_TYPE.PERIOD,'from_date':datetime(2022, 12, 12), 'to_date':datetime(2022, 12, 12)}
    # )
